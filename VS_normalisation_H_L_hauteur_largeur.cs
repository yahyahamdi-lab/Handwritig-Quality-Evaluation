...
namespace Beta_elliptic_model
{
    ...
    public class VS_normalisation_H_L_hauteur_largeur
    {
        ...
        public double[,] method_normalisation_hauteur_Largeur(double[,] data, int n, int choix)
        {
            rapport_norm_h = 128;
            ...
            if (l > 2)
            {
                ...
                if (m_x > 0)
                {
                    ...
                    {
                        if ((m_y / m_x) > 2.5)
                            rapport_norm_l = rapport_norm_h / 2.5;
                        else if ((m_y / m_x) < 0.4)
                            rapport_norm_l = rapport_norm_h * 2;
                        else
                            rapport_norm_l = rapport_norm_h;
                    }
                }
