...
{
   public class Re_echantillonnage_de_la_trajectoire_a_Delta_T_fixe
    {
        ...
        public int taille_segment_rech_delta_fixe = 1;
        ...
        public double[,] method_Re_echantillonnage_de_la_trajectoire_a_Delta_T_fixe( double[,] point_Trajectoire_matrice_xytz_colonnes)
        {
            ...
            int s = 10;
            for (int i = 1; i < point_Trajectoire_matrice_xytz_colonnes.GetLength(0); i++)
            {
               //if ((point_Trajectoire_matrice_xytz_colonnes_1[i, 0] != 0) && (point_Trajectoire_matrice_xytz_colonnes_1[i, 1] != 0))
                point_Trajectoire_matrice_xytz_colonnes_1[i, point_Trajectoire_matrice_xytz_colonnes_1.GetLength(1) - 1] = s;
                s+=10;
            }
            ...
            if (point_Trajectoire_matrice_xytz_colonnes_1.GetLength(1) >= 3)
            {
                ...
                for (int iiih = 0; iiih < abc; iiih++)
                {
                    ...
                    {
                        taille_segment_rech_delta_fixe = 1;
                        ...
                        if (taille_du_pseudo_mot_fini >= 1)
                        {
                           ...
                           // taille_segment_Re_echantillonne_a_Delta_T_fixe ++;
                            ...
                            //Console.WriteLine(taille_segment_rech_delta_fixe);
                            numero_pseudo_mot_courant = numero_pseudo_mot_courant + 1;
                            indice_point_courant_dans_pseudo_mot_courant = 0;
                ...
                for (int ji = 0; ji < nombre_de_pseudo_mots; ji++)
                {
                    ...
                    //Console.WriteLine(Re_echantillonne_a_Delta_T_fixe[ji]);
                }
                ...
                for (int iiih = 0; iiih < abc; iiih++)
                {
                    ...
                    else if (drapeau_debut_passage_levee == 0)
                    {
                        ...
                        if (taille_du_pseudo_mot_fini >= 1)
                        {
                            ...
                            //for (int i = 0; i < matrice_df_car.GetLength(0); i++)
                            ...
                            // Console.WriteLine(point_Trajectoire_segment_Re_echantillonne_a_Delta_T[numero_pseudo_mot_courant].GetLength(0));
                            //Console.ReadKey();
                            ...
                            longueur_curviligne = 0;
                             ...
                             x_suivant = point_Trajectoire_segment_filtre[Math.Min(1, size_segment_Re_echantillonne-1), 0]; // !!!
                             y_suivant = point_Trajectoire_segment_filtre[Math.Min(1, size_segment_Re_echantillonne-1), 1];
                             x_apres_suivant = point_Trajectoire_segment_filtre[Math.Min(2, size_segment_Re_echantillonne-1), 0];
                             y_apres_suivant = point_Trajectoire_segment_filtre[Math.Min(2, size_segment_Re_echantillonne-1), 1];
                             ...
                             {
                                //point_Trajectoire_segment_Re_echantillonne_a_Delta_T;
