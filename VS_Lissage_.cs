...
namespace Beta_elliptic_model
{
   public class VS_Lissage
   {
        ...
        double x_points_trace_numero_k, y_points_trace_numero_k, z_points_trace_numero_k;
       public  double[,] Method_VS_Lissage(double[,] points_equidistants, int rayon, double sigma_p)
       {
            ...
            */
            ...
            points_equidistants_lisse  = new double[points_equidistants.GetLength(0), points_equidistants.GetLength(1)];
            for (int k = 0; k < points_equidistants.GetLength(0); k++)
            {
                ...
                //z_points_trace_numero_k = points_equidistants[k, 2];
                ...
                else
                {
                    if (drapeau_baissee == 1)
                    {
                        ...
                        segment_points = new double[taille_segment, points_equidistants.GetLength(1)];
                        ...
                        for (int ijk = indice_debut_segment_courant; ijk <= indice_fin_segment_courant; ijk++)
                        {
                            ...
                            if (points_equidistants.GetLength(1) > 2)
                            { segment_points[(ijk - indice_debut_segment_courant), 2] = points_equidistants[ijk, 2]; }
                        }
                        ...
                        if (segment_points.GetLength(0) >= 2)
                        {
                            ...
                            double[,] segment_point_p = new double[segment_points.GetLength(0), segment_points.GetLength(1)];
                            ...
                            segment_points_2 = new double[segment_lisse.GetLength(0), segment_lisse.GetLength(1)];
                       ...
                       */
                        ...
                        for (int ijk = indice_debut_segment_courant; ijk <= indice_fin_segment_courant; ijk++)
                        {
                           ...
                           if (points_equidistants.GetLength(1) > 2)
                              { points_equidistants_lisse[ijk, 2] = segment_lisse_2[(ijk - indice_debut_segment_courant), 2]; }
                        }
