...
{
    public class VS_Lecture_traitement_save_param_online_beta_ellipt_DFAnCa
    {
        ...
        public double[,] method_mmatrice_param_DF_car(double[,] data, string label_du_script_choisi)
        {
            Description_par_Series_de_Fourier_dune_Traject_Online_AngCar DF_car = new Description_par_Series_de_Fourier_dune_Traject_Online_AngCar();
            VS_new_beta_ellipse_stretegy_Beta_chevauchees_s_L_DF new_beta_ellipse_DF = new VS_new_beta_ellipse_stretegy_Beta_chevauchees_s_L_DF();
            resolution_trajectoire = new VS_Inversion_et_reparation_de_la_resolution_trajectoire();
            points_total_final_filtrer = new double[2, 2];
            int nombre_de_harminiques_considerees = 10;
            ...
            if (nbr_pseudo_mot > 0)
            {
                ...
                matrice_param_descripteurs_fourier_car = DF_car.Method_vecteur_param_etendu_car(point_Trajectoire, nombre_de_harminiques_considerees, rayon_filtre_V, sigma_p_filtre_V, rayon_filtre_traject, sigma_p_filtre_traject, label_du_script_choisi);
            ...
            return matrice_param_descripteurs_fourier_car;
        }
