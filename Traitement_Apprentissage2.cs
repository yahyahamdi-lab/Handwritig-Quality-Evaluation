...
{
    public class Traitement_Apprentissage2
    {
        ...
        public void Method_Traitement_apprentissage(string label_du_script_choisi, string classe_choisie, int mise_a_jour_ou_apprentissage, int type_procedure_apprentissage, int type_extracteur, string type_de_script, string path, int type_approche, int autorisation_distance_test_faux,int choix)
        {
       ...
       /*     if (choix == 1)
            ...
            */
            ...
            else if (mise_a_jour_ou_apprentissage == 2)
            {
                    ...
                    for (int num_label = 0; num_label < number_av_files_n2; num_label++)
                    {
                        ...
                        if ((type_procedure_apprentissage == 2) && (type_extracteur == 1))
                        {
                            if (label_choisi_sans_lettre.Length == label_du_script_choisi.Length)
                            {
                                ...
                                {
                                    if (!Directory.Exists(chemin_acces_sous_dossier_param))
                                    { Directory.CreateDirectory(chemin_acces_sous_dossier_param); }
                ...
                if ((type_procedure_apprentissage ==1) && (type_extracteur ==1)|| ((type_procedure_apprentissage == 2) && (type_extracteur == 1)) || ((type_procedure_apprentissage == 3) &&(type_extracteur == 1) )|| (type_procedure_apprentissage == 4) && (type_extracteur == 1))
...

                {
                    ...
                    int n2 = rmatg.method_nombre_echantillon_DF(chemin_acces_sous_dossier_param);
                    mm_distance_DF = new double[n2, 3];

                    for (int numero_label = 0; numero_label < n2; numero_label++)
                    {
                    ...
                    if (!Directory.Exists(chemin_acces_fichier_distances_DF))
                    { Directory.CreateDirectory(chemin_acces_fichier_distances_DF); }
                    
                    if (!Directory.Exists(chemin_acces_fichier_distances_DF_0))
                    { Directory.CreateDirectory(chemin_acces_fichier_distances_DF_0); }
                    if (autorisation_distance_test_faux == 0)
                    {
                        WRDfile.Method_DeleteFiles(chemin_acces_fichier_distances_DF_0);
                    ...
                    if (!Directory.Exists(chemin_acces_fichier_distances_DF1))
                    { Directory.CreateDirectory(chemin_acces_fichier_distances_DF1); }
                    if (!Directory.Exists(chemin_acces_fichier_distances_DF_01))
                    { Directory.CreateDirectory(chemin_acces_fichier_distances_DF_01); }
                    if (autorisation_distance_test_faux == 0)
                    {
                    ...
                    int n20 = rmatg.method_nombre_echantillon_DF(chemin_acces_sous_dossier_param);

                    mm_distance_DF = new double[n20, 3];

                    for (int numero_label = 0; numero_label < n20; numero_label++)
                    {
                    ...
                    int n22 = rmatg.method_nombre_echantillon_DF(chemin_acces_sous_dossier_param);
                    mm_distance_DF = new double[n22, 3];

                    for (int numero_label = 0; numero_label < n22; numero_label++)
                    {
                    ...
                    int n23 = rmatg.method_nombre_echantillon_DF(chemin_acces_sous_dossier_param);
                    mm_distance_DF = new double[n23, 3];

                    for (int numero_label = 0; numero_label < n23; numero_label++)
                    {
...

                {
                    ...
                    int n30 = rmatg.method_nombre_echantillon(chemin_acces_sous_dossier_param);

                    mm_distance_DFcar = new double[n30, 3];

                    for (int numero_label = 0; numero_label < n30; numero_label++)
                    {
                    ...
                    int n32 = rmatg.method_nombre_echantillon(chemin_acces_sous_dossier_param);

                    mm_distance_DFcar = new double[n32, 3];

                    for (int numero_label = 0; numero_label < n32; numero_label++)
                    {
                    ...
                    int n33 = rmatg.method_nombre_echantillon(chemin_acces_sous_dossier_param);

                    mm_distance_DFcar = new double[n33, 3];

                    for (int numero_label = 0; numero_label < n33; numero_label++)
                    {
                    ...
                    int n40 = rmatg.method_nombre_echantillon(chemin_acces_sous_dossier_param);
                    mm_distance_DFcar = new double[n40, 3];

                    for (int numero_label = 0; numero_label < n40; numero_label++)
                    {
